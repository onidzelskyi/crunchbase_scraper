...
from sqlalchemy import Column, Integer, String, Date, ForeignKey, UniqueConstraint, ForeignKeyConstraint, PrimaryKeyConstraint
...
class Company(Base):
    ...
    crunchbase_link = Column(String, nullable=False)
    site_link = Column(String, nullable=False)
    linkedin_link = Column(String)
    funding_date = Column(Date)
    PrimaryKeyConstraint('name', 'funding_date', name='uix_1')
